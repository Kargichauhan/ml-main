...
model_1 = KerasRegressor(build_fn=create_model_1, verbose=1, epochs=80)
model_2 = KerasRegressor(build_fn=create_model_2, verbose=1, epochs=80)
model_3 = KerasRegressor(build_fn=create_model_3, verbose=1, epochs=80)
model_4 = KerasRegressor(build_fn=create_model_4, verbose=1, epochs=80)
model_5 = KerasRegressor(build_fn=create_model_5, verbose=1, epochs=80)
model_6 = KerasRegressor(build_fn=create_model_6, verbose=1, epochs=80)
model_7 = KerasRegressor(build_fn=create_model_7, verbose=1, epochs=80)
model_8 = KerasRegressor(build_fn=create_model_8, verbose=1, epochs=80)
model_9 = KerasRegressor(build_fn=create_model_9, verbose=1, epochs=80)
...
param_dist = {
    ...
    'model__neurons': [(1000, 750, 500,1000, 1000, 750,750, 750, 750,1000, 1000, 500, 250,1000, 750, 750, 500,1000, 1000, 1000)],
    'model__layers': [1, 2, 3],
...
model = KerasRegressor(model=create_model, verbose=1, epochs=60)  
random_search = RandomizedSearchCV(estimator=model, param_distributions=param_dist, n_iter=1000, n_jobs=-1, cv=3, random_state=42)  # Reduced n_iter for example

random_search_result = random_search.fit(X_train, y_train)

#save to csv 
result_df = pd.DataFrame(random_search_result.cv_results_)
result_df.to_csv('random_search_results4.csv',index=False)
